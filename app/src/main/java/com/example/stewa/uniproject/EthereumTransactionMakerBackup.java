...
public class EthereumTransactionMakerBackup {

    TransactionDetails transactionDetails;

    public EthereumTransactionMakerBackup(TransactionDetails transactionDetails){
        this.transactionDetails = transactionDetails;
    }

    public void performFullTransaction(){}
    ...
    public String executeAddress1toAddress2Transaction(double transactionValue, String senderPrivateKey, String senderWalletAddress, String receiverWalletAddress){
        try {
            TransactionManager address1TransactionManager = prepareTransaction(senderPrivateKey);
            TransactionReceipt transactionReceipt = executeTransaction(address1TransactionManager,receiverWalletAddress,transactionValue);
            String transactionHash = transactionReceipt.getTransactionHash();

            System.out.println("Transaction Hash = "+ transactionHash);
            return  "Transaction successful: "+transactionValue+" Ether sent from "+senderWalletAddress+" to "+receiverWalletAddress+"\n" +
